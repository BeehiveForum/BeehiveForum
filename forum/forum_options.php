...
/* $Id: forum_options.php,v 1.82 2005-05-01 22:35:30 decoyduck Exp $ */
...
echo "                        <td align=\"right\" >", form_checkbox("language_global", "Y", $lang['setforallforums'], (isset($user_prefs['LANGUAGE_GLOBAL']) ? $user_prefs['LANGUAGE_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("view_sigs_global", "Y", $lang['setforallforums'], (isset($user_prefs['VIEW_SIGS_GLOBAL']) ? $user_prefs['VIEW_SIGS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("mark_as_of_int_global", "Y", $lang['setforallforums'], (isset($user_prefs['MARK_AS_OF_INT_GLOBAL']) ? $user_prefs['MARK_AS_OF_INT_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("images_to_links_global", "Y", $lang['setforallforums'], (isset($user_prefs['IMAGES_TO_LINKS_GLOBAL']) ? $user_prefs['IMAGES_TO_LINKS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("show_thumbs_global", "Y", $lang['setforallforums'], (isset($user_prefs['SHOW_THUMBS_GLOBAL']) ? $user_prefs['SHOW_THUMBS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("enable_wiki_words_global", "Y", $lang['setforallforums'], (isset($user_prefs['ENABLE_WIKI_WORDS_GLOBAL']) ? $user_prefs['ENABLE_WIKI_WORDS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td>", form_checkbox("show_stats", "Y", $lang['showforumstats'], (isset($user_prefs['SHOW_STATS']) && $user_prefs['SHOW_STATS'] == "Y") ? true : false), "</td>\n";
echo "                        <td align=\"right\" >", form_checkbox("show_stats_global", "Y", $lang['setforallforums'], (isset($user_prefs['SHOW_STATS_GLOBAL']) ? $user_prefs['SHOW_STATS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("use_word_filter_global", "Y", $lang['setforallforums'], (isset($user_prefs['USE_WORD_FILTER_GLOBAL']) ? $user_prefs['USE_WORD_FILTER_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td colspan=\"2\">&nbsp;</td>\n";
echo "                      </tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("posts_per_page_global", "Y", $lang['setforallforums'], (isset($user_prefs['POSTS_PER_PAGE_GLOBAL']) ? $user_prefs['POSTS_PER_PAGE_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("font_size_global", "Y", $lang['setforallforums'], (isset($user_prefs['FONT_SIZE_GLOBAL']) ? $user_prefs['FONT_SIZE_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("style_global", "Y", $lang['setforallforums'], (isset($user_prefs['STYLE_GLOBAL']) ? $user_prefs['STYLE_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("emoticons_global", "Y", $lang['setforallforums'], (isset($user_prefs['EMOTICONS_GLOBAL']) ? $user_prefs['EMOTICONS_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"right\" >", form_checkbox("start_page_global", "Y", $lang['setforallforums'], (isset($user_prefs['START_PAGE_GLOBAL']) ? $user_prefs['START_PAGE_GLOBAL'] : false)), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td colspan=\"2\">&nbsp;</td>\n";
echo "                      </tr>\n";
