...
function tools_html($custom_html = "") {
	...
	echo tools_button($lang['strikethrough'], "add_tag('s');", "strikethrough_button.png");
	echo tools_button($lang['superscript'], "add_tag('sup');", "superscript_button.png");
	echo tools_button($lang['subscript'], "add_tag('sub');", "subscript_button.png");
	...
	echo tools_button($lang['numberedlist'], "add_tag('list', true, null, true);", "numbered_list_button.png");
