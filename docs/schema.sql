...
INSERT INTO THREAD (TID, FID, TITLE, LENGTH, POLL_FLAG, MODIFIED, CLOSED) VALUES (2, 2, 'The Second Thread', 1,'N', NULL, NULL);
INSERT INTO THREAD (TID, FID, TITLE, LENGTH, POLL_FLAG, MODIFIED, CLOSED) VALUES (3, 1, 'The Third Thread', 1, 'N', NULL, NULL);

INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (1, 1, 1, 0, 0, 0, 20020411150342, 'First Post!!');
...
INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (4, 3, 1, 0, 3, 4, 20020411150634, 'Another post!!111!!');
