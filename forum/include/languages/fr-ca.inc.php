...
/* $Id: fr-ca.inc.php,v 1.1 2005-05-01 21:39:44 decoyduck Exp $ */
...
$lang['messageunavailable'] = "Message non-disponible";
...
$lang['managefolder'] = "Organiser le dossier";
...
$lang['h1tag'] = "Balise H1";
$lang['subhead'] = "Sous-tête de section";
...
$lang['editstartpageexp'] = "Utiliser cette page pour modifier la page de démarrage de votre forum.";
...
$lang['norestrictedfolders'] = "Aucun dossier limité";
...
$lang['useripaddresses'] = "Adresses IP d'utilisateur";
$lang['listofthelastknownipaddresses'] = "Ceci est une liste des 10 dernières adresses IP connues pour cet utilisateur, en ordre chronologique commençant par la plus récente. Pour bannir cette adresse IP, cocher la case correspondante et cliquer le bouton d'enregistrement ci-dessous.";
$lang['cannotipbansoldiers'] = "Vous ne pouvez pas bannir d'autres soldats. Baisser leur statut avant de procéder.";
$lang['banthisipaddress'] = "Bannir cette adresse IP";
$lang['noipaddress'] = "Aucune adresse IP existe pour ce compte. L'utilisateur ne peut pas être banni par adresse IP.";
...
$lang['soldierdesc'] = "<b>Soldats</b> ont accès à tous les outils de modération, mais ne peuvent pas créer ou enlever d'autres soldats.";
$lang['workerdesc'] = "<b>Ouvriers</b> peuvent modifier ou supprimer n'importe lequel message.";
$lang['wormdesc'] = "<b>Parasites</b> peuvent lire les messages et poster comme normal, mais leurs messages apparaîtront comme messages supprimés aux autres utilisateurs.";
$lang['waspdesc'] = "<b>Guêpes</b> peuvent lire les messages, mais ne peuvent pas y répondre ou poster de nouveau messages.";
$lang['splatdesc'] = "<b>Tapettes</b> ne peuvent accéder au forum. Utiliser cette mesure pour bannir des idiots récividistes.";
...
$lang['manageusersexp_3'] = "Pour voir les derniers utilisateurs qui ont ouvert une session, trier la list par DERNIÈRE_OUVERTURE_DE_SESSION.";
$lang['manageallusersexp'] = "Cette liste démontre tous les comptes d'utilisateurs inscrits triés par";
$lang['lastlogon'] = "Dernière ouverture de session";
$lang['logonfrom'] = "Ouverture de session de";
...
$lang['showingactions'] = "Démontrant les actions";
...
$lang['unbanneduser'] = "Utilisateur dé-banni";
...
$lang['folderisnotrestricted'] = "Dossier avec accès non limité. Etablir le niveau d'accès à Limité avant d'ajouter/enlever des utilisateurs.";
...
$lang['addtogroup'] = "Ajouter au groupe";
...
$lang['changeemailaddress'] = "Changer adresse courriel";
$lang['donothing'] = "Ne faites rien";

$lang['userhasglobalaccesstoadmintools'] = "L'utilisateur a un accès global aux outils admin";
...
$lang['groupisglobalmod'] = "Groupe est un modérateur global";
...
$lang['textcaptchafonterror_1'] = "Le Captcha de texte a été désactivé automatiquement parce qu'il n'y a pas de polices truetype de disponible pour son usage. SVP téléverser des polices truetype à";
$lang['textcaptchafonterror_2'] = "sur votre serveur.";
...
$lang['percentofthisperiodsposts'] = "Pourcentage des contributions de cette période";
...
$lang['warningnoforums'] = "MISE EN GARDE: Vous n'avez aucune installation de forum.";

// Admin Global User Permissions

$lang['globaluserpermissions'] = "droits d'accès d'utilisateur globaux";
$lang['globalusershelptext'] = "Ces droits d'accès permettent l'utilisateur d'accéder aux outils Admin et / ou aux outils de Forum sur <b>tous</b> les forums.";
...
$lang['unknownstylename'] = "Nom de style inconnu";
$lang['unknownemoticonsname'] = "Nom de binettes inconnu";
$lang['unknownlanguage'] = "Langage inconnu";
...
$lang['changeclosedmessage'] = "Changer message fermé";
...
$lang['errorhandler'] = "Gestionnaire d'erreurs";
$lang['showfriendlyerrors'] = "Montrer messages d'erreur amicaux";
$lang['gzipcompression'] = "Compression GZIP";
$lang['compresspagesusinggzip'] = "Compresser les pages avec GZIP";
$lang['gzipcompressionlevel'] = "Niveau de compression GZIP";
$lang['cookieoptions'] = "Options de témoin";
$lang['cookiedomain'] = "Domaine de témoin";
...
$lang['showdeletedattachments'] = "Montrer fichiers joints supprimés dans le message";
...
$lang['forum_settings_help_1'] = "Beehive peut faire appel à son propre gestionnaire d'erreurs afin de montrer des messages d'erreur plus amicaux que les messages PHP par défaut. Toutefois, cette option peut causer des problèmes avec certaines versions de PHP, alors si vous rencontrez des problèmes avec des pages vierges avec cette option activée, svp la désactiver.";
$lang['forum_settings_help_2'] = "Cette option active la compression GZIP prédéfinie de Beehive. La compression de la sortie des scripts peut vous sauver des montants considérable de bande passante, mais elle peut aussi accroître la charge de l'unité centrale du serveur et ralentir le tout.";
$lang['forum_settings_help_3'] = "Si votre serveur exécute PHP 4.2.0. ou version ultérieure, vous pouvez aussi changer le niveau maximal de compression qui doit être utilisé. Le plus élevé le niveau, le plus grand la charge sur le serveur.";
$lang['forum_settings_help_4'] = "<b>MISE EN GARDE:</b> Si vous utilisez mod_gzip ou tout autre module de gzippage pour gérer la compression de scripts PHP sur votre serveur web, <b>NE PAS</b> activer la compression GZIP prédéfinie de Beehive ou vous risqué de rendre votre forum inaccessible.";
$lang['forum_settings_help_5'] = "Cette option spécifie le nom du domaine que les témoins fixés par Beehive devraient utiliser. Ceci est utile pour les situation où il y a plus qu'un point d'accès pour votre forum.";
$lang['forum_settings_help_6'] = "Par example, supposons les adresses URL suivantes sont toutes les deux des points d'accès valides pour le même forum:";
$lang['forum_settings_help_7'] = "http://forum.mybeehiveforum.net/<br />http://www.mybeehiveforum.net/forum/";
$lang['forum_settings_help_8'] = "Afin d'éviter que les utilisateurs doivent ouvrir une session aux deux points d'accès, vous pourriez établir la valeur ci-dessus à &quot;mybeehiveforum.net&quot; et les témoins pour la page d'ouverture de session ainsi que les témoins principaux de session fonctionneront pour chacun des deux adresses URL.";
$lang['forum_settings_help_9'] = "<b>MISE EN GARDE:</b> Ne changer pas cette option si vous ne comprenez pas ce qu'elle fait. L'établissant à une valeur invalide ou inexacte rendra votre forum inaccessible.";
...
$lang['attachmentnospace'] = "Désolé, vous n'avez pas assez d'espace pour fichier joint de libre. Veuillez libérer de l'espace et essayer de nouveau.";
$lang['successfullyuploaded'] = "Téléversement réussi";
$lang['failedtoupload'] = "Téléversement échoué:";
$lang['errorfilesizeis0'] = "Erreur: Taille de fichier doit être supérieure à 0 octet";
...
$lang['nowpress'] = "Maintenant appuyer";
$lang['ifdoneattachingfiles'] = "Si vous avez terminé de joindre des fichiers, appuyer";
...
$lang['removefile'] = "Enlever fichier";
...
$lang['gotologin'] = "Aller à l'écran d'ouverture de session";
...
$lang['invalidaccess'] = "Accès invalide";
...
$lang['editappliedtopoll'] = "Révision appliquée au scrutin";
$lang['errorupdatingpost'] = "Erreur rencontrée durant la mise à jour du message";
$lang['editmessage'] = "Réviser le message";
$lang['edittext'] = "Réviser le texte";
$lang['editHTML'] = "Réviser le HTML";
...
$lang['errorpleasewaitandretry'] = "Une erreur a été rencontré. Veuillez patienter quelques minutes avant de cliquer le bouton de relance ci-dessous.";
$lang['retry'] = "Relancer";
$lang['multipleerroronpost'] = "Cette erreur a été rencontré plusieurs fois en essayant de poster/prévisionner votre message. Pour votre convenance, nous avons inclut ci-dessous votre texte de message et, si pertinent, les numéros du fil de discussion et du message auquel vous répondiez. VOus pouvez ainsi sauvegarder une copie du texte en attendant que le forum retrouve sa fonctionalité.";
$lang['replymsgnumber'] = "Numéro de message de réponse";
$lang['errormsgfordevs'] = "Message d'erreur pour les admins de serveurs et les développeurs";
...
$lang['noframessupport'] = "Désolé, votre navigateur web ne supporte pas les cadres";
$lang['uselightversion'] = "Vous devez utiliser la version HTML légère du forum <a href=\"llogon.php\">ici</a>.";
...
$lang['nocommentsposted'] = "Aucun commentaire n'a été posté.";
...
$lang['usernameandpasswdrequired'] = "Un nom d'utilisateur et un mot de passe sont requis";
...
$lang['unnamedforum'] = "Forum sans nom";
...
$lang['messagecontainsHTML'] = "Le message contient du HTML";
$lang['notincludingsignature'] = "(à l'exception de la signature)";
...
$lang['converttoHTML'] = "Convertir en HTML";
...
$lang['emoticonsinmessage'] = "Binettes dans le message";
...
$lang['reopenforposting'] = "Ré-ouvrir pour les contributions";
$lang['closeforposting'] = "Fermer aux contributions";
$lang['preventediting'] = "Empêcher la révision";
$lang['allowediting'] = "Permettre la révision";
$lang['makesticky'] = "Rendre collant";
$lang['makenonsticky'] = "Rendre non-collant";
...
$lang['nomessagespecifiedforreply'] = "Aucun message spécifié pour répondre à";
...
$lang['oldermessages'] = "Messages plus anciens";
$lang['newermessages'] = "Messages plus récents";
...
$lang['newrelationship'] = "Nouvelle relation";
...
$lang['userdetails'] = "Détails d'utilisateur";
$lang['leaveblanktoretaincurrentpasswd'] = "Laissez vide pour conserver mot de passe actuel";
...
$lang['ageanddob'] = "Âge et date de naissance";
...
$lang['privacysettings'] = "Options de confidentialité";
...
$lang['mustenterpollquestion'] = "Vous devez inclure une question de scrutin";
...
$lang['cannotcreatemultivotepublicballot'] = "Vous ne pouvez pas créer des scrutins publiques multi-votes. Les scrutins publiques exigent l'utilisation de journalisation des votes afin de fonctionner.";
...
$lang['pollresultnote'] = "<b>Note:</b> Le choix de 'Vote publique' annulera le type de résultat du scrutin.";
$lang['horizgraph'] = "Graphique horizontale";
$lang['vertgraph'] = "Graphique verticale";
$lang['tablegraph'] = "Format tabulaire";
$lang['publicviewable'] = "Vote publique";
...
$lang['usernamemustnotcontainHTML'] = "Le nom d'utilisateur ne doit pas inclure des balises HTML";
...
$lang['nicknamemustnotcontainHTML'] = "Le pseudonyme de doit pas inclure des balises HTML";
$lang['nicknamerequired'] = "Un pseudonume est requis";
$lang['emailmustnotcontainHTML'] = "L'adresse courriel ne doit pas contenir des balises HTML";
...
$lang['itemsmarkedwithaasterixarerequired'] = "Items marqués avec un * sont requis";
...
$lang['ignoredusers'] = "Utilisateurs ignorés";
$lang['ignoredsignatures'] = "Signatures ignorées";
...
$lang['wordsshorterthan_2'] = "charactères ne seront pas inclus";
...
$lang['poststoandfrommeonly'] = "Messages à et de moi seulement";
...
$lang['showmorevisitors'] = "Montrer d'autres visiteurs";
...
$lang['uploadstartpage'] = "Téléverser page de démarrage (*.txt, *.php, *.htm)";
...
$lang['couldnotretrieveforuminformation'] = "Aucun forum de disponible.";
...
$lang['adminoptions'] = "Options admin";
