...
echo "<form name=\"f_mode\" method=\"get\" action=\"lthread_list.php?webtag=$webtag\">\n        ";
...
if (bh_session_get_value('UID') != 0) {
    ...
    echo "    <form name=\"f_mark\" method=\"get\" action=\"lthread_list.php?webtag=$webtag\">\n";
...
echo "<p><a href=\"llogout.php?webtag=$webtag\">{$lang['logout']}</a></p>\n";
