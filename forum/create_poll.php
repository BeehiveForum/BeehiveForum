...
html_draw_top(sprintf("title=%s", gettext("Create Poll")), "basetarget=_blank", "resize_width=960", "js/post.js", "js/poll.js", "js/attachments.js", "js/emoticons.js", 'ckeditor/ckeditor.js', 'js/fineuploader.min.js', 'class=window_title');
