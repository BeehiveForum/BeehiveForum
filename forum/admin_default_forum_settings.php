...
if (isset($_POST['save']) || isset($_POST['confirm_unread_cutoff']) || isset($_POST['cancel_unread_cutoff'])) {
    ...
    if (isset($_POST['sphinx_search_index']) && preg_match('/^[a-z]+[a-z0-9]+$/Diu', trim(stripslashes_array($_POST['sphinx_search_index'])))) {
        $new_forum_settings['sphinx_search_index'] = trim(stripslashes_array($_POST['sphinx_search_index']));
    }else {
        $new_forum_settings['sphinx_search_index'] = "";
    }
    ...
    if ($valid) {
        ...
        if (!isset($_POST['confirm_unread_cutoff'])) {
            ...
            if (($unread_cutoff_stamp > 0) && ($previous_unread_cutoff_stamp !== false) && ($unread_cutoff_stamp != $previous_unread_cutoff_stamp)) {
                ...
                echo "<h1>{$lang['admin']}<img src=\"", html_style_image('separator.png'), "\" alt=\"\" border=\"0\" />{$lang['globalforumsettings']}</h1>\n";
                echo "<br />\n";
...
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\">{$lang['sphinxsearchindexname']}:</td>\n";
echo "                        <td align=\"left\">", form_input_text("sphinx_search_index", (isset($forum_global_settings['sphinx_search_index'])) ? htmlentities_array($forum_global_settings['sphinx_search_index']) : '', 35), "&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                    <table class=\"posthead\" width=\"95%\">\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" width=\"255\" style=\"white-space: nowrap\">{$lang['adsensepublisherid']}:</td>\n";
...
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" style=\"white-space: nowrap\">{$lang['adsensemediumadid']}:</td>\n";
...
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" style=\"white-space: nowrap\">{$lang['adsensesmalladid']}:</td>\n";
