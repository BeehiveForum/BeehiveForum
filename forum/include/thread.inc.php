...
function thread_get($tid)
{
   ...
   $sql.= "UNIX_TIMESTAMP(THREAD.MODIFIED) AS MODIFIED, THREAD.CLOSED, USER_THREAD.INTEREST AS INTEREST FROM ";
   $sql.= forum_table("THREAD") . " LEFT JOIN ". forum_table("USER_THREAD"). " ";
