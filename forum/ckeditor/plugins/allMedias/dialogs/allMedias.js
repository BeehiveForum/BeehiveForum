...
(function () {
    ...
    var ATTRTYPE_OBJECT = 1,
        ...
        attributesMap = {
            allowScriptAccess: [
                {type: ATTRTYPE_PARAM, name: 'allowScriptAccess'},
                {type: ATTRTYPE_EMBED, name: 'allowScriptAccess'}
            ],
            allowFullScreen: [
                {type: ATTRTYPE_PARAM, name: 'allowFullScreen'},
                {type: ATTRTYPE_EMBED, name: 'allowFullScreen'}
            ],
            align: [
                {type: ATTRTYPE_OBJECT, name: 'align'}
            ],
            bgcolor: [
                {type: ATTRTYPE_PARAM, name: 'bgcolor'},
                {type: ATTRTYPE_EMBED, name: 'bgcolor'}
            ],
            base: [
                {type: ATTRTYPE_PARAM, name: 'base'},
                {type: ATTRTYPE_EMBED, name: 'base'}
            ],
            'class': [
            ...
            loop: [
                {type: ATTRTYPE_PARAM, name: 'loop'},
                {type: ATTRTYPE_EMBED, name: 'loop'}
            ],
            mtype: [
                {type: ATTRTYPE_OBJECT, name: 'mtype'},
                {type: ATTRTYPE_EMBED, name: 'mtype'}
            ],	//add by webmote
            menu: [
                {type: ATTRTYPE_PARAM, name: 'menu'},
                {type: ATTRTYPE_EMBED, name: 'menu'}
            ],
            name: [
            ...
            play: [
                {type: ATTRTYPE_PARAM, name: 'play'},
                {type: ATTRTYPE_EMBED, name: 'autostart'}
            ],
            quality: [
                {type: ATTRTYPE_PARAM, name: 'quality'},
                {type: ATTRTYPE_EMBED, name: 'quality'}
            ],
            src: [
                {type: ATTRTYPE_PARAM, name: 'movie'},
                {type: ATTRTYPE_EMBED, name: 'rsrc'},
                {type: ATTRTYPE_OBJECT, name: 'data'}
            ],
            scale: [
                {type: ATTRTYPE_PARAM, name: 'scale'},
                {type: ATTRTYPE_EMBED, name: 'scale'}
            ],
            style: [
            ...
            salign: [
                {type: ATTRTYPE_PARAM, name: 'salign'},
                {type: ATTRTYPE_EMBED, name: 'salign'}
            ],
            seamlesstabbing: [
                {type: ATTRTYPE_PARAM, name: 'seamlesstabbing'},
                {type: ATTRTYPE_EMBED, name: 'seamlesstabbing'}
            ],
            type: [
            ...
            wmode: [
                {type: ATTRTYPE_PARAM, name: 'wmode'},
                {type: ATTRTYPE_EMBED, name: 'wmode'}
            ]
        },
        i;
                ...
                if (fakeImage && fakeImage.data('cke-real-element-type') && fakeImage.data('cke-real-element-type') == 'allMedias') {
                    ...
                    if (realElement.getName() == 'cke:object') {
                        ...
                        for (i = 0, length = paramList.count(); i < length; i++) {
                            ...
                            item = paramList.getItem(i);

                            name = item.getAttribute('name');

                            paramMap[ name ] = item.getAttribute('value');
                        }
                                            ...
                                            onLoad: function () {
                                                var dialog = this.getDialog(),
                                                    updatePreview = function (src) {
                                                        ...
                                                        dialog.preview.setHtml('<embed ' + objsrc + ' autostart="true' + '" type="' + mp.types[mp.idx] + '"></embed>');
                                                    };
