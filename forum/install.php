...
/* $Id: install.php,v 1.50 2005-08-27 11:03:34 decoyduck Exp $ */
    ...
    if ($valid) {
        ...
        if ($db_install = @db_connect()) {
            ...
            if (($install_method == 5) && (@file_exists('./install/upgrade-06rc-to-06.php'))) {
                ...
                include_once("./install/upgrade-06rc-to-06.php");

            }elseif (($install_method == 4) && (@file_exists('./install/upgrade-05-to-06.php'))) {
...
if (!@file_exists(BH_INCLUDE_PATH. "config.inc.php") || $force_install) {
    ...
    echo "                            <option value=\"4\" ", (isset($install_method) && $install_method == 4) ? "selected=\"selected\"" : "", ">Upgrade 0.5 to 0.6.1</option>\n";
    echo "                            <option value=\"5\" ", (isset($install_method) && $install_method == 5) ? "selected=\"selected\"" : "", ">Upgrade 0.6RCx to 0.6.1</option>\n";
    echo "                          </select>\n";
    echo "                        </td>\n";
    echo "                      </tr>\n";
    echo "                      <tr>\n";
