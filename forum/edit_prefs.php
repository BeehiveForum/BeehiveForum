...
/* $Id: edit_prefs.php,v 1.5 2004-03-04 20:30:35 decoyduck Exp $ */
...
if (isset($HTTP_POST_VARS['submit'])) {
    ...
    if ($valid) {
        ...
        if (isset($HTTP_SERVER_VARS['SERVER_SOFTWARE']) && !strstr($HTTP_SERVER_VARS['SERVER_SOFTWARE'], 'Microsoft-IIS')) {
            ...
            header_redirect("./edit_prefs.php?updated=true");
            ...
            echo "<!--\n";
            echo "document.location.href = './edit_prefs.php?updated=true';\n";
            echo "//-->\n";
            echo "</script>";
            ...
            form_quick_button("./edit_prefs.php", $lang['continue'], "", "", "_top");
