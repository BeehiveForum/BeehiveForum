...
#
# $Id: upgrade-04-to-05.sql,v 1.13 2004-05-22 21:04:57 decoyduck Exp $
#
# --------------------------------------------------------#
...
CREATE TABLE DEFAULT_FOLDER_NEW (
...
INSERT INTO DEFAULT_FOLDER_NEW (TITLE, DESCRIPTION, ALLOWED_TYPES, PERM, POSITION)
SELECT TITLE, DESCRIPTION, ALLOWED_TYPES, 252, POSITION
FROM DEFAULT_FOLDER WHERE ACCESS_LEVEL = 0 OR ACCESS_LEVEL = 1;

INSERT INTO DEFAULT_FOLDER_NEW (TITLE, DESCRIPTION, ALLOWED_TYPES, PERM, POSITION)
SELECT TITLE, DESCRIPTION, ALLOWED_TYPES, 0, POSITION
FROM DEFAULT_FOLDER WHERE ACCESS_LEVEL = -1;

DROP TABLE DEFAULT_FOLDER;

ALTER TABLE DEFAULT_FOLDER_NEW RENAME DEFAULT_FOLDER;
...
INSERT INTO DEFAULT_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Queen', 0);

INSERT INTO DEFAULT_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER.UID FROM USER WHERE STATUS & 32 > 0;

INSERT INTO DEFAULT_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), 0, 1536;

INSERT INTO DEFAULT_GROUPS (AUTO_GROUP) VALUES (1);

INSERT INTO DEFAULT_GROUP_USERS (GID, UID) 
SELECT LAST_INSERT_ID(), UID FROM USER WHERE STATUS & 32 > 0;

INSERT INTO DEFAULT_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), FID, 508 FROM DEFAULT_FOLDER;

# Soldiers

INSERT INTO DEFAULT_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Soldiers', 0);
...
INSERT INTO DEFAULT_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Wormed', 0);
...
INSERT INTO DEFAULT_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Banned', 0);
...
INSERT INTO DEFAULT_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER_FOLDER.UID FROM DEFAULT_USER_FOLDER USER_FOLDER
LEFT JOIN USER USER ON (USER.UID = USER_FOLDER.UID)
WHERE USER_FOLDER.ALLOWED = 1 AND USER.STATUS IS NULL OR USER.STATUS = 0;

INSERT INTO DEFAULT_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), USER_FOLDER.FID, 252 FROM DEFAULT_USER_FOLDER USER_FOLDER
LEFT JOIN USER USER ON (USER.UID = USER_FOLDER.UID)
WHERE USER_FOLDER.ALLOWED = 1 AND USER.STATUS IS NULL OR USER.STATUS = 0;

ALTER TABLE USER DROP STATUS;
ALTER TABLE DEFAULT_USER_FOLDER DROP ALLOWED;
