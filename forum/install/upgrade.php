...
foreach ($forum_prefix_array as $forum_fid => $table_data) {
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_ADMIN_LOG` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_BANNED` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_FOLDER` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_FORUM_LINKS` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_LINKS` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_LINKS_COMMENT` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_LINKS_FOLDERS` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_LINKS_VOTE` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_POLL` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_POST_CONTENT` ";
    $sql.= "CHANGE TID TID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    $sql.= "CHANGE PID PID MEDIUMINT(8) UNSIGNED NOT NULL AFTER TID";

    $db->query($sql);

    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_POST_RECIPIENT` ";
    $sql.= "ADD KEY VIEWED(VIEWED)";

    $db->query($sql);

    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_PROFILE_ITEM` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_PROFILE_SECTION` ";
    $sql.= "CHANGE NAME NAME VARCHAR(64) COLLATE UTF8_GENERAL_CI NOT NULL AFTER PSID, ";
    $sql.= "CHANGE POSITION POSITION MEDIUMINT(3) UNSIGNED NOT NULL AFTER NAME";

    $db->query($sql);

    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_RSS_FEEDS` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_RSS_HISTORY` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_STATS` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_THREAD` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_THREAD_STATS` ";
    $sql.= "CHANGE TID TID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    $sql.= "CHANGE VIEWCOUNT VIEWCOUNT MEDIUMINT(8) UNSIGNED NOT NULL AFTER TID";

    $db->query($sql);

    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_THREAD_TRACK` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_USER_FOLDER` ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_USER_PEER` ";
    $sql.= "CHANGE UID UID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_USER_PROFILE` ";
    $sql.= "CHANGE UID UID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_USER_SIG` ";
    $sql.= "CHANGE UID UID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    $sql.= "DROP COLUMN HTML";

    $db->query($sql);

    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_USER_THREAD` ";
    $sql.= "CHANGE UID UID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
    ...
    $sql = "ALTER TABLE `{$table_data['WEBTAG']}_WORD_FILTER` ";
	$sql.= "CHANGE UID UID MEDIUMINT(8) UNSIGNED NOT NULL FIRST, ";
