...
/* $Id: display.php,v 1.72 2006-12-10 17:08:56 decoyduck Exp $ */
...
html_draw_top("title=$forum_name > {$threaddata['TITLE']}", "onload=resizeImages()", "onload=addOverflow()", "openprofile.js", "post.js", "basetarget=_blank", "robots=index,follow");
