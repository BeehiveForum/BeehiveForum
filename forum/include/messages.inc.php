...
/* $Id: messages.inc.php,v 1.363 2005-04-20 22:10:22 decoyduck Exp $ */
    ...
    if ($in_list && !$is_preview) {
        ...
        if ($message['PID'] != 1) {
            ...
            if ($message['PID'] == $first_msg) {
                ...
                $up_arrow.= "<img src=\"". style_image("message_up.png"). "\" width=\"10\" border=\"0\" alt=\"{$lang['prev']}\" title=\"{$lang['prev']}\" /></a> ";
