...
# ======================================================================
#
# $Id: upgrade.sql,v 1.4 2004-05-22 21:05:01 decoyduck Exp $
...
CREATE TABLE {forum_webtag}_FOLDER_NEW (
...
INSERT INTO {forum_webtag}_FOLDER_NEW (TITLE, DESCRIPTION, ALLOWED_TYPES, PERM, POSITION)
SELECT TITLE, DESCRIPTION, ALLOWED_TYPES, 252, POSITION
FROM {forum_webtag}_FOLDER WHERE ACCESS_LEVEL = 0 OR ACCESS_LEVEL = 1;

INSERT INTO {forum_webtag}_FOLDER_NEW (TITLE, DESCRIPTION, ALLOWED_TYPES, PERM, POSITION)
SELECT TITLE, DESCRIPTION, ALLOWED_TYPES, 0, POSITION
FROM {forum_webtag}_FOLDER WHERE ACCESS_LEVEL = -1;

DROP TABLE {forum_webtag}_FOLDER;

ALTER TABLE {forum_webtag}_FOLDER_NEW RENAME {forum_webtag}_FOLDER;
...
INSERT INTO FORUMS (WEBTAG, {forum_webtag}_FORUM) VALUES('DEFAULT', 1);
...
INSERT INTO {forum_webtag}_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Queen', 0);

INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER.UID FROM USER WHERE STATUS & 32 > 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), 0, 1536;

INSERT INTO {forum_webtag}_GROUPS (AUTO_GROUP) VALUES (1);

INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID) 
SELECT LAST_INSERT_ID(), UID FROM USER WHERE STATUS & 32 > 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), FID, 508 FROM {forum_webtag}_FOLDER;

# Soldiers

INSERT INTO {forum_webtag}_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Soldiers', 0);

INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER.UID FROM USER WHERE STATUS & 16 > 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), 0, 512;
...
INSERT INTO {forum_webtag}_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Wormed', 0);

INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER.UID FROM USER WHERE STATUS & 4 > 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), 0, 2;

# Banned

INSERT INTO {forum_webtag}_GROUPS (GROUP_NAME, AUTO_GROUP) VALUES ('Banned', 0);

INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER.UID FROM USER WHERE STATUS & 1 > 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), 0, 1;
...
INSERT INTO {forum_webtag}_GROUP_USERS (GID, UID)
SELECT LAST_INSERT_ID(), USER_FOLDER.UID FROM {forum_webtag}_USER_FOLDER USER_FOLDER
LEFT JOIN USER USER ON (USER.UID = USER_FOLDER.UID)
WHERE USER_FOLDER.ALLOWED = 1 AND USER.STATUS IS NULL OR USER.STATUS = 0;

INSERT INTO {forum_webtag}_GROUP_PERMS (GID, FID, PERM)
SELECT LAST_INSERT_ID(), USER_FOLDER.FID, 252 FROM {forum_webtag}_USER_FOLDER USER_FOLDER
LEFT JOIN USER USER ON (USER.UID = USER_FOLDER.UID)
WHERE USER_FOLDER.ALLOWED = 1 AND USER.STATUS IS NULL OR USER.STATUS = 0;

ALTER TABLE USER DROP STATUS;
ALTER TABLE {forum_webtag}_USER_FOLDER DROP ALLOWED;
