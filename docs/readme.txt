...
Don't panic. Pop over to http://beehiveforum.sourceforge.net/forum and ask us
...
going to http://beehiveforum.sourceforge.net/forums.php
...
If you know how to do CSS, you can edit the style.css file in the forum/styles
folder to change colors, fonts and things like that. We recommend taking a
backup first, though, in case you make a mess of it.


1.3.2 Images
============

Feel free to edit the images in the forum/images folder too, as long as the
sizes remain the same. Again, you might want to take backups.


1.3.3 The top frame
===================

The very top frame is yours to do with as you wish. In the forum folder you will
...
- Polls are inoperative in this version - expect for 0.2.
- Sometimes a problem with the next/previous 50 in the thread list
- The Opera browser doesn't display everything right. As usual.
- Attachments are a bit of a work in progress, future versions may not be
  compatible
- No "forgotten password" retrieval - expect as a patch very soon
...
You can also try dropping in to http://beehiveforum.sourceforge.net/forum, which
