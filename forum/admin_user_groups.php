...
/* $Id: admin_user_groups.php,v 1.31 2006-10-29 23:07:22 decoyduck Exp $ */
...
echo "<h1>{$lang['admin']} &raquo; ", (isset($forum_settings['forum_name']) ? $forum_settings['forum_name'] : 'A Beehive Forum'), " &raquo; {$lang['usergroups']}</h1>\n";
