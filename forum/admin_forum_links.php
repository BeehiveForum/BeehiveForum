...
/* $Id: admin_forum_links.php,v 1.40 2007-03-25 14:44:48 decoyduck Exp $ */
    ...
    if (sizeof($forum_links_array['forum_links_array']) > 0) {
        ...
        foreach($forum_links_array['forum_links_array'] as $key => $forum_link) {
            ...
            if ($forum_links_array['forum_links_count'] == 1) {
                ...
                echo "                  <td align=\"left\" colspan=\"2\"><a href=\"admin_forum_links.php?webtag=$webtag&amp;page=$page&amp;lid={$forum_link['LID']}\">{$forum_link['TITLE']}</a></td>\n";
