...
#
# $Id: upgrade-04-to-05.sql,v 1.5 2004-04-23 22:09:53 decoyduck Exp $
#
# --------------------------------------------------------#
...
ALTER TABLE DEFAULT_USER_PREFS ADD IMAGES_TO_LINKS CHAR(1);

ALTER TABLE DEFAULT_USER_PREFS ADD USE_WORD_FILTER CHAR(1);
ALTER TABLE DEFAULT_USER_PREFS ADD USE_ADMIN_FILTER CHAR(1);

ALTER TABLE DEFAULT_FILTER_LIST ADD UID MEDIUMINT(8) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE DEFAULT_FILTER_LIST CHANGE FILTER MATCH_TEXT VARCHAR(255) NOT NULL;
ALTER TABLE DEFAULT_FILTER_LIST ADD REPLACE_TEXT VARCHAR(255) NOT NULL;
ALTER TABLE DEFAULT_FILTER_LIST ADD FILTER_OPTION TINYINT(1) UNSIGNED DEFAULT '0' NOT NULL;
...
ALTER TABLE DEFAULT_USER_PREFS ADD EMOTICONS VARCHAR(255);
ALTER TABLE DEFAULT_USER_PREFS ADD ALLOW_EMAIL CHAR(1);
ALTER TABLE DEFAULT_USER_PREFS ADD ALLOW_PM CHAR(1);

UPDATE DEFAULT_USER_PREFS SET ALLOW_PM = 'Y' WHERE ALLOW_PM IS NULL;
UPDATE DEFAULT_USER_PREFS SET ALLOW_EMAIL = 'Y' WHERE ALLOW_EMAIL IS NULL;
