...
/* $Id: admin_forum_set_passwd.php,v 1.1 2005-03-23 20:34:30 decoyduck Exp $ */
...
echo "<h1>{$lang['admin']} : ", (isset($forum_settings['forum_name']) ? $forum_settings['forum_name'] : 'Unknown Forum'), " : {$lang['changepassword']}</h1>\n";
