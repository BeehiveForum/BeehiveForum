...
/* $Id: admin_folders.php,v 1.129 2007-05-21 00:14:20 decoyduck Exp $ */
...
if (sizeof($folder_array['folder_array']) > 0) {
    ...
    foreach ($folder_array['folder_array'] as $key => $folder) {
        ...
        if ($folder_array['folder_count'] == 1) {
            ...
            echo "                  <td align=\"left\" colspan=\"2\"><a href=\"admin_folder_edit.php?webtag=$webtag&amp;page=$page&amp;fid={$folder['FID']}\" title=\"Click To Edit Folder Details\">{$folder['TITLE']}</a></td>\n";
...
echo "    </tr>\n";
echo "    <tr>\n";
echo "      <td class=\"postbody\" align=\"center\">", page_links(get_request_uri(true, false), $start, $folder_array['folder_count'], 10), "</td>\n";
echo "    </tr>\n";
echo "    <tr>\n";
echo "      <td align=\"left\">&nbsp;</td>\n";
echo "    </tr>\n";
