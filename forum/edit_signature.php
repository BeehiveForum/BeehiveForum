...
/* $Id: edit_signature.php,v 1.136 2010-01-17 11:31:49 decoyduck Exp $ */
...
if ($admin_edit === true) {
    ...
    html_draw_top("title={$lang['admin']} Â» {$lang['manageuser']} Â» ". format_user_name($user['LOGON'], $user['NICKNAME']), "basetarget=_blank", "onUnload=clearFocus()", "resize_width=600", "dictionary.js", "htmltools.js", "post.js");

    echo "<h1>{$lang['admin']} &raquo; {$lang['manageuser']} &raquo; ", format_user_name($user['LOGON'], $user['NICKNAME']), "</h1>\n";

}else {

    html_draw_top("title={$lang['mycontrols']} Â» {$lang['editsignature']}", "basetarget=_blank", "onUnload=clearFocus()", "resize_width=600", "dictionary.js", "htmltools.js", "post.js");
