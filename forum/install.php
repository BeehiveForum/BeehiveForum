...
if (isset($_POST['install_method']) && (!defined('BEEHIVE_INSTALED') || $force_install)) {
    ...
    if ($valid) {
        ...
        if ($db_install = db_connect(false)) {
            ...
            }elseif (($install_method == 3) && (@file_exists('./install/upgrade-06x-to-07.php'))) {
            ...
            if ($valid) {
                ...
                if (@$fp = fopen('./install/config.inc.php', 'r')) {
                    ...
                    if ($config_saved) {
                        ...
                        echo "                </tr>\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\">Installation of your Beehive Forum has completed successfully, but before you can use it you must delete both the install folder and install.php. Once this has been done you can click Continue below to start using your Beehive Forum.</td>\n";
                        echo "                </tr>\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\">&nbsp;</td>\n";
                        echo "                </tr>\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\" width=\"500\"><span class=\"bhinputcheckbox\"><input type=\"checkbox\" name=\"install_remove_files\" id=\"install_remove_files\" value=\"Y\" checked=\"checked\"><label for=\"install_remove_files\">Attempt automatic removal of installation files (recommended)</label></span></td>\n";
                        echo "                </tr>\n";
                        echo "              </table>\n";
                        echo "            </td>\n";
                        echo "          </tr>\n";
                        ...
                        echo "              <table class=\"posthead\" width=\"100%\">\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\" class=\"subhead\">Database Setup Completed</td>\n";
                        echo "                </tr>\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\">Your database has been succesfully setup for use with Beehive. However we were unable to automatically apply the changes to your config.inc.php.</td>\n";
                        echo "                <tr>\n";
                        echo "                  <td align=\"left\">&nbsp;</td>\n";
                        echo "                </tr>\n";
                        echo "                <tr>\n";
    ...
    if (@$fp = fopen('./install/config.inc.php', 'r')) {
        ...
        if (isset($db_server) && isset($db_database) && isset($db_username) && isset($db_password)) {
            ...
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">Oops! It would appear that we don't have enough information to be able to send you your config.inc.php. This would only have happened if the previous page didn't send us the right information.</td>\n";
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">&nbsp;</td>\n";
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">Fortunately you can still get your Beehive Forum functional by following these simple instructions:</td>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">\n";
            echo "                  <ol>\n";
            ...
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">Once you've done all of that you can click the Continue button below to start using your Beehive Forum.</td>\n";
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\">&nbsp;</td>\n";
            echo "              </tr>\n";
            echo "              <tr>\n";
            echo "                <td align=\"left\"><b>config.inc.php:</b></td>\n";
            echo "              </tr>\n";
            echo "              <tr>\n";
...
if (!@file_exists(BH_INCLUDE_PATH. "config.inc.php") || $force_install) {
    ...
    echo "                  <td nowrap=\"nowrap\" class=\"subhead\" align=\"right\"><a href=\"javascript:void(0)\" target=\"_blank\" onclick=\"return show_install_help(0)\" tabindex=\"15\"><img src=\"./images/help.png\" border=\"0\" alt=\"Help!\" title=\"Help!\" /></a></td>\n";
    echo "                </tr>\n";
    echo "                <tr>\n";
    ...
    echo "                  <td nowrap=\"nowrap\" class=\"subhead\" align=\"right\"><a href=\"javascript:void(0)\" target=\"_blank\" onclick=\"return show_install_help(1)\" tabindex=\"16\"><img src=\"./images/help.png\" border=\"0\" alt=\"Help!\" title=\"Help!\" /></a></td>\n";
    echo "                </tr>\n";
    echo "                <tr>\n";
    echo "                  <td align=\"center\" colspan=\"2\">\n";
    echo "                    <table cellpadding=\"2\" cellspacing=\"0\" width=\"95%\">\n";
    ...
    echo "                  <td nowrap=\"nowrap\" class=\"subhead\" align=\"right\"><a href=\"javascript:void(0)\" target=\"_blank\" onclick=\"return show_install_help(2)\" tabindex=\"17\"><img src=\"./images/help.png\" border=\"0\" alt=\"Help!\" title=\"Help!\" /></a></td>\n";
    echo "                </tr>\n";
    echo "                <tr>\n";
    echo "                  <td align=\"center\" colspan=\"2\">\n";
    echo "                    <table cellpadding=\"2\" cellspacing=\"0\" width=\"95%\">\n";
    ...
    echo "                  <td nowrap=\"nowrap\" class=\"subhead\" align=\"right\"><a href=\"javascript:void(0)\" target=\"_blank\" onclick=\"return show_install_help(3)\" tabindex=\"18\"><img src=\"./images/help.png\" border=\"0\" alt=\"Help!\" title=\"Help!\" /></a></td>\n";
    echo "                </tr>\n";
    echo "                <tr>\n";
    echo "                  <td align=\"center\" colspan=\"2\">\n";
    echo "                    <table cellpadding=\"2\" cellspacing=\"0\" width=\"95%\">\n";
    ...
    echo "    </tr>\n";
    echo "    <tr>\n";
    echo "      <td align=\"center\"><input type=\"submit\" name=\"install\" value=\"Install\" class=\"button\" target=\"_blank\" onclick=\"return confirm_install(this);\" tabindex=\"14\" /></td>\n";
    echo "    </tr>\n";
    echo "  </table>\n";
    echo "</div>\n";
    echo "</form>\n";
