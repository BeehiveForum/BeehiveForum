...
/* $Id: admin_default_forum_settings.php,v 1.72 2007-06-02 13:17:15 decoyduck Exp $ */
...
if (isset($_POST['submit'])) {
    ...
    $forum_global_settings = array_merge_keys($forum_global_settings, $new_forum_settings);
}
