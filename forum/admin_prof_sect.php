...
/* $Id: admin_prof_sect.php,v 1.70 2005-03-21 14:33:02 decoyduck Exp $ */
...
// Draw the form
echo "<h1>{$lang['admin']} : ", (isset($forum_settings['forum_name']) ? $forum_settings['forum_name'] : 'Unknown Forum'), " : {$lang['manageprofilesections']}</h1>\n";
echo "<br />\n";
