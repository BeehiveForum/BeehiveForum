...
/* $Id: admin_default_forum_settings.php,v 1.65 2007-04-12 13:23:08 decoyduck Exp $ */
...
echo "                        <td align=\"left\">", form_radio("require_email_confirmation", "Y", $lang['yes'], (isset($default_forum_settings['require_email_confirmation']) && $default_forum_settings['require_email_confirmation'] == 'Y')), "&nbsp;", form_radio("require_email_confirmation", "N", $lang['no'], (isset($default_forum_settings['require_email_confirmation']) && $default_forum_settings['require_email_confirmation'] == 'N') || !isset($default_forum_settings['require_email_confirmation'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" width=\"250\">{$lang['usetextcaptcha']}:</td>\n";
echo "                        <td align=\"left\">", form_radio("text_captcha_enabled", "Y", $lang['yes'], (isset($default_forum_settings['text_captcha_enabled']) && $default_forum_settings['text_captcha_enabled'] == 'Y')), "&nbsp;", form_radio("text_captcha_enabled", "N", $lang['no'], (isset($default_forum_settings['text_captcha_enabled']) && $default_forum_settings['text_captcha_enabled'] == 'N') || !isset($default_forum_settings['text_captcha_enabled'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"left\">", form_radio("pm_allow_attachments", "Y", $lang['yes'] , (isset($default_forum_settings['pm_allow_attachments']) && $default_forum_settings['pm_allow_attachments'] == 'Y')), "&nbsp;", form_radio("pm_allow_attachments", "N", $lang['no'] , ((isset($default_forum_settings['pm_allow_attachments']) && $default_forum_settings['pm_allow_attachments'] == 'N')) || !isset($default_forum_settings['pm_allow_attachments'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "                        <td align=\"left\">", form_radio("allow_search_spidering", "Y", $lang['yes'], (isset($default_forum_settings['allow_search_spidering']) && $default_forum_settings['allow_search_spidering'] == 'Y')), "&nbsp;", form_radio("allow_search_spidering", "N", $lang['no'], (isset($default_forum_settings['allow_search_spidering']) && $default_forum_settings['allow_search_spidering'] == 'N') || !isset($default_forum_settings['allow_search_spidering'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" colspan=\"2\">\n";
...
echo "                        <td align=\"left\">", form_radio("guest_show_recent", "Y", $lang['yes'], (isset($default_forum_settings['guest_show_recent']) && $default_forum_settings['guest_show_recent'] == 'Y') || !isset($default_forum_settings['guest_show_recent'])), "&nbsp;", form_radio("guest_show_recent", "N", $lang['no'], (isset($default_forum_settings['guest_show_recent']) && $default_forum_settings['guest_show_recent'] == 'N')), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" colspan=\"2\">\n";
...
echo "                        <td align=\"left\">", form_radio("attachments_enabled", "Y", $lang['yes'], (isset($default_forum_settings['attachments_enabled']) && $default_forum_settings['attachments_enabled'] == 'Y')), "&nbsp;", form_radio("attachments_enabled", "N", $lang['no'], (isset($default_forum_settings['attachments_enabled']) && $default_forum_settings['attachments_enabled'] == 'N') || !isset($default_forum_settings['attachments_enabled'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td align=\"left\" width=\"270\">{$lang['allowembeddingofattachments']}:</td>\n";
echo "                        <td align=\"left\">", form_radio("attachments_allow_embed", "Y", $lang['yes'], (isset($default_forum_settings['attachments_allow_embed']) && $default_forum_settings['attachments_allow_embed'] == 'Y')), "&nbsp;", form_radio("attachments_allow_embed", "N", $lang['no'], (isset($default_forum_settings['attachments_allow_embed']) && $default_forum_settings['attachments_allow_embed'] == 'N') || !isset($default_forum_settings['attachments_allow_embed'])), "</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
