...
$lang['stylenofilename'] = "You did not enter a filename to which to save the style.";
...
$lang['searchenginespidering'] = "Search Engine Spider-ing";
$lang['allowsearchenginespidering'] = "Allow Search Engine Spider-ing";
...
$lang['textcaptchafonterror_1'] = "Text Captcha has been disabled automatically because there are no true type fonts available for it to use. Please upload some true type fonts to";
...
$lang['attachmentdirblank'] = "You must supply a directory name in which to save attachments";
...
$lang['forum_settings_help_14'] = "<b>Min search word length</b> defines the minimum word length for which a search is allowed. Words smaller than the value specified will be removed from the query automatically.";
...
$lang['forum_settings_help_24'] = "<b>Attachment Dir</b> is the directory in which Beehive should store it's attachments. This directory must exist on your web space and must be writable by the web server / PHP process otherwise uploads will fail.";
...
$lang['forum_settings_help_28'] = "This setting allows your forum to be spider-ed by search engines like Google, AltaVista and Yahoo. If you switch this option off your forum will not be included in these search engines results.";
...
$lang['forum_settings_help_36'] = "<b>Restricted</b> allows you to set a list of users who are allowed access to your forum.";
