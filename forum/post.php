...
if($newthread){
    ...
    echo "<tr><td>".form_input_text("t_threadtitle", htmlentities($t_threadtitle), 30,64);    
    echo "\n";
...
echo "<tr><td>Signature:<br />".form_textarea("t_sig",htmlspecialchars(stripslashes($t_sig)),4,80);
