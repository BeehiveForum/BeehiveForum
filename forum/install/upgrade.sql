...
# ======================================================================
#
# $Id: upgrade.sql,v 1.5 2004-05-24 18:01:37 decoyduck Exp $
...
CREATE TABLE DEFAULT_BH_PERM_CONVERT (
  GID MEDIUMINT(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  FID MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0',
  UID MEDIUMINT(8) UNSIGNED NOT NULL DEFAULT '0',
  PERM INT(32) UNSIGNED NOT NULL DEFAULT '0',
...
INSERT INTO DEFAULT_BH_PERM_CONVERT (FID, UID, PERM)
SELECT 0, USER.UID, 1536 FROM USER WHERE STATUS & 32 > 0;

INSERT INTO DEFAULT_BH_PERM_CONVERT (FID, UID, PERM)
SELECT 0, USER.UID, 512 FROM USER WHERE STATUS & 16 > 0;

INSERT INTO DEFAULT_BH_PERM_CONVERT (FID, UID, PERM)
SELECT 0, USER.UID, 2 FROM USER WHERE STATUS & 4 > 0;

INSERT INTO DEFAULT_BH_PERM_CONVERT (FID, UID, PERM)
SELECT 0, USER.UID, 1 FROM USER WHERE STATUS & 1 > 0;

INSERT INTO DEFAULT_GROUPS (AUTO_GROUP)
SELECT 1 FROM DEFAULT_BH_PERM_CONVERT;

INSERT INTO DEFAULT_GROUP_USERS (GID, UID)
SELECT GID, UID FROM DEFAULT_BH_PERM_CONVERT;

INSERT INTO DEFAULT_GROUP_PERMS (GID, FID, PERM)
SELECT GID, FID, PERM FROM DEFAULT_BH_PERM_CONVERT;

DELETE FROM DEFAULT_BH_PERM_CONVERT;

# Folder Permissions

INSERT INTO DEFAULT_BH_PERM_CONVERT (FID, UID, PERM)
SELECT FID, UID, 252 FROM DEFAULT_USER_FOLDER USER_FOLDER
WHERE USER_FOLDER.ALLOWED = 1;
...
DROP TABLE {forum_webtag}_BH_PERM_CONVERT;
