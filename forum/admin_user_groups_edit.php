...
/* $Id: admin_user_groups_edit.php,v 1.83 2010/01/29 20:54:27 decoyduck Exp $ */
...
html_draw_top("title={$lang['admin']} » {$lang['manageusergroups']} » {$group['GROUP_NAME']}");

$group_users_array = perm_group_get_users($gid, 0);

echo "<h1>{$lang['admin']} &raquo; {$lang['manageusergroups']} &raquo; {$group['GROUP_NAME']}</h1>\n";
