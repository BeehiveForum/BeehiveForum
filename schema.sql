...
INSERT INTO THREAD (TID, FID, TITLE, POLL_FLAG, CLOSED) VALUES (1, 1, 'The First Thread', NULL, NULL);
INSERT INTO THREAD (TID, FID, TITLE, POLL_FLAG, CLOSED) VALUES (2, 2, 'The Second Thread', NULL, NULL);
INSERT INTO THREAD (TID, FID, TITLE, POLL_FLAG, CLOSED) VALUES (3, 1, 'The Third Thread', NULL, NULL);

INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (1, 1, 1, NULL, 0, 0, 20020411150342, 'First Post!!');
INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (2, 1, 2, 1, 1, 0, 20020411150408, 'Second Post!!');
INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (3, 2, 1, 0, 2, 0, 20020411150440, 'Wibble.');
INSERT INTO POST (PID, TID, POST_NUM, REPLY_TO_PID, FROM_UID, TO_UID, CREATED, CONTENT) VALUES (4, 3, 1, NULL, 3, 4, 20020411150634, 'Another post!!111!!');
