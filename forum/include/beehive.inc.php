...
/* $Id: beehive.inc.php,v 1.42 2005-03-19 17:53:34 decoyduck Exp $ */
...
function draw_beehive_bar()
{
    ...
    echo "    </td>\n";
    echo "    <td width=\"40%\" align=\"right\" class=\"smalltext\">&copy;2002 - ", date("Y", gmmktime()), " <a href=\"http://www.beehiveforum.net/\" target=\"_blank\">Project Beehive Forum</a></td>\n";
    echo "  </tr>\n";
    echo "</table>\n";
    echo "</div>\n";
}
