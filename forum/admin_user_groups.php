...
/* $Id: admin_user_groups.php,v 1.19 2005-03-21 14:33:03 decoyduck Exp $ */
...
echo "<h1>{$lang['admin']} : ", (isset($forum_settings['forum_name']) ? $forum_settings['forum_name'] : 'Unknown Forum'), " : {$lang['usergroups']}</h1>\n";
