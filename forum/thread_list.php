...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="postbody" colspan="2">
      ...
      <img src="./images/star.png" width="14" height="14" alt="" />&nbsp;<a href="search.php" target="right">Search</a><br />
    </td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
...
if ($start_from != 0 && $mode == 0 && !isset($folder)) echo "<tr><td class=\"smalltext\" colspan=\"2\"><img src=\"./images/star.png\" width=\"14\" height=\"14\" alt=\"\" />&nbsp;<a href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?mode=0&start_from=".($start_from - 50)."\">Previous 50 threads</a></td></tr><tr><td>&nbsp;</td></tr>\n";
...
echo "<tr>\n<td colspan=\"2\">&nbsp;</td></tr>\n<tr>\n<td class=\"smalltext\" colspan=\"2\"><img src=\"./images/star.png\" width=\"14\" height=\"14\" alt=\"\" />&nbsp;<a href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?mark_all_read=1\">Mark discussions as read</a></td></tr>\n";
echo "</table>\n";
