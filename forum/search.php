...
/* $Id: search.php,v 1.218 2008-07-25 16:47:28 decoyduck Exp $ */
...
if (isset($_GET['show_stop_words'])) {
    ...
    for ($i = 0; $i < sizeof($mysql_fulltext_stopwords); $i++) {
        ...
        if (isset($highlight_keywords_preg) && preg_match("/^$highlight_keywords_preg$/i", $mysql_fulltext_stopwords[$i]) > 0) {
