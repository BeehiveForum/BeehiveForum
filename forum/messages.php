...
echo "        <g:plusone size=\"small\" count=\"false\" href=\"",  htmlentities(html_get_forum_uri("/index.php?webtag=$webtag&msg=$tid.$pid")), "\"></g:plusone>\n";
echo "      </div>\n";
echo "      <div style=\"display: inline-block; width: 47px; vertical-align: middle; margin-top: 2px; overflow: hidden\">\n";
echo "        <iframe src=\"http://www.facebook.com/plugins/like.php?href=", urlencode(html_get_forum_uri("/index.php?webtag=$webtag&msg=$tid.$pid")), "&amp;send=false&amp;layout=button_count&amp;width=450&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:450px; height:21px;\" allowTransparency=\"true\"></iframe>\n";
echo "      </div>\n";
echo "      <div style=\"display: inline-block; width: 55px; vertical-align: middle; overflow: hidden\">\n";
echo "        <a href=\"http://twitter.com/share\" class=\"twitter-share-button\" data-url=\"", htmlentities(html_get_forum_uri("/index.php?webtag=$webtag&msg=$tid.$pid")), "\" data-count=\"none\">Tweet</a>\n";
echo "      </div>\n";
echo "    </td>\n";
echo "  </tr>\n";
echo "</table>\n";
