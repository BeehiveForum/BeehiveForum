...
/* $Id: install_script.php,v 1.1 2004-05-24 19:33:07 decoyduck Exp $ */
...
$sql.="INSERT INTO {forum_webtag}_FOLDER VALUES ('General', NULL, NULL, 252, 0);";
...
$sql.="INSERT INTO {forum_webtag}_GROUPS VALUES ('Queen', NULL, 0);";
...
$sql.="INSERT INTO {forum_webtag}_LINKS_FOLDERS VALUES (1, NULL, 'Top Level', 'Y');";
...
$sql.="INSERT INTO {forum_webtag}_POST VALUES (1, 1, 0, 1, 0, NULL, NOW(), 0, NULL, 0, '');";
...
$sql.="INSERT INTO {forum_webtag}_PROFILE_ITEM VALUES (1, 'Location', 0, 0);";
...
$sql.="INSERT INTO {forum_webtag}_PROFILE_SECTION VALUES ('Personal', 0);";
...
$sql.="INSERT INTO {forum_webtag}_STATS VALUES ('0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0);";
...
$sql.="INSERT INTO {forum_webtag}_THREAD VALUES (1, NULL, 'Welcome', 1, 'N', NOW(), NULL, 'N', NULL, NULL);";
...
$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'forum_name', 'A Beehive Forum');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'forum_email', 'admin@abeehiveforum.net');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, '{forum_webtag}_style', 'default');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, '{forum_webtag}_emoticon', 'default');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, '{forum_webtag}_language', 'en');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'show_stats', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'show_links', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'auto_logon', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'show_pms', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'pm_allow_attachments', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'maximum_post_length', '6226');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'allow_post_editing', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'post_edit_time', '0');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'allow_polls', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'search_min_word_length', '3');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'attachments_enabled', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'attachments_dir', 'attachments');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'attachments_allow_embed', 'N');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'attachments_use_old_method', 'N');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'guest_account_active', 'Y');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'session_cutoff', '86400');";

if(!$result = mysql_query($sql, $db_install)) {
    return mysql_error();
}

$sql.="INSERT INTO FORUM_SETTINGS VALUES (1, 'active_session_cutoff', '900');";
...
$sql.="INSERT INTO FORUMS VALUES ('DEFAULT', 1, 0);";
...
$sql.="INSERT INTO USER VALUES ('ADMIN', MD5('honey'), 'Administrator', 'your@email.com');";
