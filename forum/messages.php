...
/* $Id: messages.php,v 1.215 2007-01-15 00:10:34 decoyduck Exp $ */
...
html_draw_top("title=$forum_name > {$threaddata['TITLE']}", "openprofile.js", "post.js", "poll.js", "basetarget=_blank", "robots=index,follow", "onload=resizeImages(0, '{$lang['imageresized']}')", "onload=addOverflow()");
    ...
    foreach ($tracking_data_array as $tracking_data) {
        ...
        if ($tracking_data['TRACK_TYPE'] == 0) { // Thread merged
            ...
            if ($tracking_data['NEW_TID'] == $tid) {
                ...
                $thread_link = "<a href=\"messages.php?webtag=$webtag&amp;msg=%s.1\" target=\"_self\">%s</a>";
                $thread_link = sprintf($thread_link, $tracking_data['TID'], $lang['threadhere']);
