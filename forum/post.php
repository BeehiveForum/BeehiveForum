...
/* $Id: post.php,v 1.290 2007-01-17 18:36:22 decoyduck Exp $ */
...
html_draw_top("onUnload=clearFocus()", "onload=resizeImages(720, '{$lang['imageresized']}')", "onload=addOverflow(720)", "basetarget=_blank", "post.js", "poll.js", "openprofile.js", "htmltools.js", "emoticons.js", "dictionary.js");
...
echo form_input_text("t_to_uid_others", "", 0, 0, "onclick=\"checkToRadio(". ($newthread ? 1 : 2). ")\"", "post_to_others"), form_submit_image("search_button.png", "search", $lang['search'], "onclick=\"return openLogonSearch('$webtag', 't_to_uid_others', ". ($newthread ? 1 : 2). ");\" title=\"{$lang['search']}\"", "search_button"), "<br /><br />\n";
