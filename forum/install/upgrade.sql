...
# ======================================================================
#
# $Id: upgrade.sql,v 1.2 2004-05-09 00:57:49 decoyduck Exp $
...
ALTER TABLE {forum_webtag}_FILTER_LIST ADD UID MEDIUMINT(8) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE {forum_webtag}_FILTER_LIST CHANGE FILTER MATCH_TEXT VARCHAR(255) NOT NULL;
ALTER TABLE {forum_webtag}_FILTER_LIST ADD REPLACE_TEXT VARCHAR(255) NOT NULL;
ALTER TABLE {forum_webtag}_FILTER_LIST ADD FILTER_OPTION TINYINT(1) UNSIGNED DEFAULT '0' NOT NULL;
