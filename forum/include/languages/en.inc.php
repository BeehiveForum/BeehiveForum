...
$lang['startpageerror'] = "Start page could not be saved. Please try again.";
...
$lang['topbanner'] = "Top Banner";
$lang['topbannererror'] = "Top Banner could not be saved. Please try again.";
...
$lang['mustchooseaendday'] = "Must choose an end day";
$lang['mustchooseaendmonth'] = "Must choose an end month";
$lang['mustchooseaendyear'] = "Must choose an end year";
...
$lang['forumrulesmessage'] = "<p><b>Forum Rules</b></p><p>Registration to %1\$s is free! We do insist that you abide by the rules and policies detailed below. If you agree to the terms, please check the 'I agree' checkbox and press the 'Register' button below. If you would like to cancel the registration, click %2\$s to return to the forums index.</p><p>Although the administrators and moderators of %1\$s will attempt to keep all objectionable messages off this forum, it is impossible for us to review all messages. All messages express the views of the author, and neither the owners of %1\$s, nor Project Beehive Forum and its affiliates will be held responsible for the content of any message.</p><p>By agreeing to these rules, you warrant that you will not post any messages that are obscene, vulgar, sexually-orientated, hateful, threatening, or otherwise in violation of any laws.</p><p>The owners of %1\$s reserve the right to remove, edit, move or close any thread for any reason.</p>";
...
$lang['contentdeliverynetwork'] = "Content Delivery";
$lang['contentdeliverynetworkpaths'] = "Content Delivery Network Paths";
...
$lang['unreadcutoffincreasewarning'] = "Increasing the unread cut-off will make threads marked as modified since and threads older than the previous cut-off appear as unread to all users";
...
$lang['disableemoticonsinmessage'] = "Disable emoticons";
...
$lang['textcaptchaexplain'] = "To prevent automated registrations this forum requires you enter a confirmation code. The code is displayed in the image to the right. If you are visually impaired or cannot otherwise read the code please contact the %s.";
...
$lang['unreadstartedbyfriend'] = "Unread started by friend";
...
$lang['maxitemcount'] = "Max Item Count";
$lang['maxitemcounthint'] = "Min: 1, Max: 10";
...
$lang['maxitemcountmustbebetween1and10'] = "Max Item Count must be between 1 and 10";
