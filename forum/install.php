...
/* $Id: install.php,v 1.87 2008-02-19 14:29:24 decoyduck Exp $ */
...
if (isset($_POST['install_method'])) {
    ...
    if ($valid) {
        ...
        if ($db_install = db_connect(false)) {
            ...
            if (($install_method == 5) && (@file_exists('install/upgrade-08x-to-083.php'))) {

                include_once("install/upgrade-08x-to-083.php");

            }elseif (($install_method == 4) && (@file_exists('install/upgrade-07x-to-083.php'))) {

                include_once("install/upgrade-07x-to-083.php");

            }elseif (($install_method == 3) && (@file_exists('install/upgrade-06x-to-083.php'))) {

                include_once("install/upgrade-06x-to-083.php");
...
echo "                            <option value=\"3\" ", (isset($install_method) && $install_method == 3) ? "selected=\"selected\"" : "", ">Upgrade 0.6.x to 0.8.3</option>\n";
echo "                            <option value=\"4\" ", (isset($install_method) && $install_method == 4) ? "selected=\"selected\"" : "", ">Upgrade 0.7.x to 0.8.3</option>\n";
echo "                            <option value=\"5\" ", (isset($install_method) && $install_method == 5) ? "selected=\"selected\"" : "", ">Upgrade 0.8.x to 0.8.3</option>\n";
echo "                          </select>\n";
echo "                        </td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
