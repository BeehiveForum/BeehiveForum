...
/* $Id: admin_visitor_log.php,v 1.1 2006-11-24 20:59:25 decoyduck Exp $ */
...
echo "<h1>{$lang['admin']} &raquo; ", (isset($forum_settings['forum_name']) ? $forum_settings['forum_name'] : 'A Beehive Forum'), " &raquo; {$lang['visitorlog']}</h1>\n";
echo "<br />\n";
    ...
    if (sizeof($admin_visitor_log_array['user_array']) > 0) {
        ...
        foreach ($admin_visitor_log_array['user_array'] as $visitor) {
            ...
            if (isset($visitor['SID']) && !is_null($visitor['SID'])) {
                ...
                echo "                   <td class=\"postbody\" align=\"left\"><a href=\"javascript:void(0)\" target=\"_self\" onclick=\"openProfile({$visitor['UID']}, '$webtag')\">", add_wordfilter_tags(add_wordfilter_tags(format_user_name($visitor['LOGON'], $visitor['NICKNAME']))), "</a></td>\n";
