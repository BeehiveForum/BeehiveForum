...
/* $Id: lmessages.php,v 1.27 2004-03-17 17:20:35 decoyduck Exp $ */
...
if ($last_pid < $threaddata['LENGTH']) {
    $npid = $last_pid + 1;
    form_quick_button("./lmessages.php", $lang['keepreading'], array("msg", "webtag"), array("$tid.$npid", $webtag['WEBTAG']));
}
