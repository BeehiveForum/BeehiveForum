...
/* $Id: edit_email.php,v 1.58 2006-10-14 19:11:35 decoyduck Exp $ */
...
echo "              <table class=\"posthead\" width=\"100%\">\n";
echo "                <tr>\n";
echo "                  <td colspan=\"2\" class=\"subhead\">{$lang['birthdayanddateofbirth']}</td>\n";
echo "                </tr>\n";
echo "              </table>\n";
echo "              <table class=\"posthead\" width=\"100%\">\n";
echo "                <tr>\n";
...
echo "                    <table class=\"posthead\" width=\"95%\">\n";
echo "                      <tr>\n";
echo "                        <td colspan=\"2\">", form_radio("dob_display", 0, $lang['donotshowmyageordobtoothers'], ((isset($user_prefs['DOB_DISPLAY']) && $user_prefs['DOB_DISPLAY'] == 0) || !isset($user_prefs['DOB_DISPLAY'])) ? true : false), "</td>\n";
...
echo "                      </tr>\n";
echo "                      <tr>\n";
echo "                        <td colspan=\"2\">", form_radio("dob_display", 3, "Show only my day and month of birth to others", (isset($user_prefs['DOB_DISPLAY']) && $user_prefs['DOB_DISPLAY'] == 3) ? true : false), "</td>\n";
echo "                        <td>&nbsp;</td>\n";
echo "                      </tr>\n";
echo "                      <tr>\n";
...
echo "              <table class=\"posthead\" width=\"100%\">\n";
echo "                <tr>\n";
echo "                  <td colspan=\"2\" class=\"subhead\">{$lang['forumanonymity']}</td>\n";
echo "                </tr>\n";
echo "              </table>\n";
echo "              <table class=\"posthead\" width=\"100%\">\n";
echo "                <tr>\n";
...
echo "                    <table class=\"posthead\" width=\"95%\">\n";
echo "                      <tr>\n";
echo "                        <td colspan=\"2\">", form_radio("anon_logon", 0, $lang['listmeontheactiveusersdisplay'], ((isset($user_prefs['ANON_LOGON']) && $user_prefs['ANON_LOGON'] == 0) || !isset($user_prefs['ANON_LOGON'])) ? true : false), "</td>\n";
