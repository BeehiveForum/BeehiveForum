...
/* $Id: threads.inc.php,v 1.313 2008-07-27 10:53:37 decoyduck Exp $ */
...
function threads_get_all($uid, $start = 0) // get "all" threads (i.e. most recent threads, irrespective of read or unread status).
{
    ...
    if (user_is_guest()) {
        ...
        $sql.= "THREAD.DELETED, THREAD.LENGTH, THREAD.POLL_FLAG, THREAD.STICKY, FOLDER.PREFIX, ";
        ...
        $sql.= "UNIX_TIMESTAMP(THREAD.MODIFIED) AS MODIFIED, USER.LOGON, ";
...
function threads_get_unread($uid) // get unread messages for $uid
{
    ...
    $sql.= "OR USER_FOLDER.INTEREST > -1) AND THREAD.DELETED = 'N' ";
    $sql.= "ORDER BY THREAD.STICKY DESC, THREAD.MODIFIED DESC ";
    $sql.= "LIMIT 0, 50";
