...
/* $Id: forum_options.php,v 1.15 2004-03-17 17:20:35 decoyduck Exp $ */
...
if (isset($HTTP_POST_VARS['submit'])) {
    ...
    if (isset($HTTP_SERVER_VARS['SERVER_SOFTWARE']) && !strstr($HTTP_SERVER_VARS['SERVER_SOFTWARE'], 'Microsoft-IIS')) {
        ...
        form_quick_button("./forum_options.php", $lang['continue'], "webtag", $webtag['WEBTAG'], "_top");
...
echo "                </tr>\n";
echo "                <tr>\n";
echo "                  <td>", form_checkbox("use_word_filter", "Y", $lang['usewordfilter'], (isset($user_prefs['USE_WORD_FILTER']) && $user_prefs['USE_WORD_FILTER'] == "Y")), "&nbsp;<span class=\"smalltext\">[<a href=\"edit_wordfilter.php\">{$lang['editwordfilter']}</a>]</span></td>\n";
echo "                </tr>\n";
echo "                <tr>\n";
echo "                  <td colspan=\"2\">&nbsp;</td>\n";
echo "                </tr>\n";
